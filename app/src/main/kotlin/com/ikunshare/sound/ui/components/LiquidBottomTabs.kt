...
fun LiquidBottomTabs(
    ...
    BoxWithConstraints(
        ...
        val tabWidth = with(density) {
            (constraints.maxWidth.toFloat() - horizontalPadding.dp.toPx()) / tabsCount
        }
        ...
        val panelOffset by remember(density) {
            derivedStateOf {
                ...
                with(density) {
                    (verticalPadding).dp.toPx() * fraction.sign * EaseOut.transform(abs(fraction))
                }
            }
        }
        ...
        //     snapshotFlow { dampedDragAnimation.targetValue.roundToInt() }
        ...
        Box(
            Modifier
                ...
                .graphicsLayer {
                    translationX =
                        if (currentIsLtr) dampedDragAnimation.value * currentTabWidth + panelOffset
